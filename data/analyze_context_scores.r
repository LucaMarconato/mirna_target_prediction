...
my_hist <- hist(2^a$context_score[2^a$context_score < 0.1], breaks = 100, plot = F)
my_hist$counts <- log10(my_hist$counts + 0.00000000001)
plot(my_hist, ylab = 'log10(counts)', ylim = c(0,7))
...
my_hist <- hist(2^a$weighted_context_score[2^a$weighted_context_score < 0.1], breaks = 100, plot = F)
my_hist$counts <- log10(my_hist$counts + 0.00000000001)
plot(my_hist, ylab = 'log10(counts)', ylim = c(0,7))
